...
<div class="first_section_background_color">
  ...
  <li class="nav-item"><a class="nav-link" href="einsert.php">Insert</a></li>
  <li class="nav-item"><a class="nav-link" href="ereport.php">Report</a></li>
  <li class="nav-item"><a class="nav-link" href="edelete1.php">Delete</a></li>
  <li class="nav-item"><a class="nav-link"  href="eupdate.php">Update</a></li>
  <li class="nav-item"><a class="nav-link"  href="equery.php">Query</a></li>
</ul>
    ...
    <div class="first_section_data">
      ...
      <div class="row">
        ...
        <div class="col-lg-9 ">
          <div class="infoText">
            <h2>The Page promising to fill all your needs!</h2>

            <p></p>
            <p style="font-size: 1.2rem; font-weight: 500;">Welcome to my employee website and enjoy the ride. </p>
            <p></p>

            <p></p>
            <a href="#"> <button class="first_section_button2 btn btn-lg btn-block" type="button" name="button"> Learn More </button></a>
            <a href="#"> <button class="first_section_button2 btn btn-lg  btn-block" type="button" name="button"> Try It </button></a>
            <a href="SE.php"><button class="first_section_button2 btn btn-lg  btn-block" type="back" name="Back">Back</button></a>
          </div>
        </div>
